  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-14">
      ...
      <nav className="flex items-center justify-center gap-3 mt-10">
        <Link href={`/lab/${Math.max(1, current - 1)}`} aria-disabled={current <= 1}
        ...
        <Link href={`/lab/${Math.min(totalPages, current + 1)}`} aria-disabled={current >= totalPages}
